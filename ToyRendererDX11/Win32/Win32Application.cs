...
using static ToyRendererDX11.Win32.Kernel32;
...
namespace ToyRendererDX11.Win32
{
    public class Win32Application : Application
    {
        ...
        public unsafe Win32Application(bool headless = false) : base(headless)
        {
            ...
            {
                // Create main window.
                MainWindow = new Win32Window("ToyRenderer ", 800, 600);
            }
        }
                ...
                default:
                    {
                        ...
                        if (scanCode <= 127)
                        {
                            ...
                            switch (scanCode)
                            {
                                ...
                                case 0x70: return KeyboardKey.None;
                                case 0x71: return KeyboardKey.None;
                                case 0x72: return KeyboardKey.None;
                                case 0x73: return KeyboardKey.None;
                                ...
                                case 0x79: return KeyboardKey.None;
                                case 0x7A: return KeyboardKey.None;
                                case 0x7B: return KeyboardKey.None;
                                case 0x7C: return KeyboardKey.None;
                                case 0x7D: return KeyboardKey.None;
